...
app.controller('ApplicationController', ['$rootScope', '$http', 'WebService', '$filter', function( $rootScope, $http, WebService, $filter ){
...
app.factory('WebService', ['$http', function( $http ){
  ...
  // API Dark Sky
  var apiKey = '570ba28ef354b0b9f3e6a77582e8c5d6';
